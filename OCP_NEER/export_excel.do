		...
		* INDEX ARITHMETIC
			...
			* month 
				...
				foreach file of local myfiles { 
					...
					drop if dup > 1
					drop dup 
					local x = ustrregexra("`file'", "reer_neer_month_weights|\.dta", "")
					if ("`x'" == "_agg2") {
					keep if product == 1 
					}
					if ("`x'" == "_agg1") { 
		...
		* Variation arithmetic
			* Year
				...
				foreach file of local myfiles { 
					...
					drop if dup > 1
					drop dup 
					local x = ustrregexra("`file'", "reer_variation_neer_year_weights|\.dta", "")
					if ("`x'" == "_agg2") {
					keep if product == 1 
					}
					if ("`x'" == "_agg1") { 
			...
			* month 
				...
				foreach file of local myfiles { 
					...
					drop if dup > 1
					drop dup 
					local x = ustrregexra("`file'", "reer_variation_neer_month_weights|\.dta", "")
					if ("`x'" == "_agg2") {
					keep if product == 1 
					}
					if ("`x'" == "_agg1") { 
