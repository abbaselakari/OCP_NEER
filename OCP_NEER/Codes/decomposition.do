...
project, uses("`pdir'/data_derived/reer/year/reer_neer_year_weights_agg1.dta")
project, uses("`pdir'/data_derived/reer/year/reer_neer_year_weights_agg2.dta")
project, uses("`pdir'/data_derived/reer/year/reer_neer_year_weights.dta")
...
gen sum11 = ln_neer - ln_neer[_n-1] 
...
bysort year : egen sum_var_term = sum(var_term)
gen sum11 = ln_reer - ln_reer[_n-1] 
bysort year : replace sum11 = sum11[_n-1] if sum11 == 0 & _n>1
replace sum11 = 0 if sum11 == .
tw (line sum_var_term year) (line sum11 year)
